    ...
    <>
      ...
      <div className="min-h-screen w-full flex bg-light-blue-800">
        <div className="flex flex-col md:flex-row items-center justify-center px-8">
          <div className="md:w-3/12 w-7/12 mr-10">
            <img src="./MaskotMusik1.png" alt="" />
          </div>
          <div className="w-full md:w-6/12">
            <div className="text-cust-yellow md:text-justify text-center font-lato">
              <p>
              Musik tradisional adalah musik yang lahir dan berkembang di suatu daerah tertentu, kemudian diwariskan secara turun-temurun. Musik tradisional memiliki ciri khas tersendiri yang membedakannya dengan musik dari daerah lain. Musik tradisional memiliki peran penting dalam menjaga dan melestarikan kebudayaan Indonesia.
              </p>
            </div>
            <div className="flex flex-col md:flex-row mt-6 font-lato">
              <CheckUser forLoggedOut>
                <div>
                  <Link to="/register/musik">
