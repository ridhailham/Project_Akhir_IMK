    ...
    <>
      ...
      <div className="min-h-screen w-full flex bg-light-blue-800">
        <div className="flex flex-col md:flex-row items-center justify-center px-8">
          <div className="md:w-3/12 w-4/12 lg:mt-0 mt-10 mr-10">
            <img src={maskotTeater} alt="" />
          </div>
          <div className="w-full md:w-6/12">
            <div className="text-cust-yellow md:text-justify text-center font-medium font-lato">
            Teater adalah bentuk seni pertunjukan langsung yang melibatkan penampilan aktor di hadapan audiens. Dalam berbagai genre seperti drama, komedi, dan musikal, teater mengekspresikan naratif melalui dialog, aksi fisik, musik, dan unsur visual. Pertunjukan dapat berlangsung di berbagai lokasi, dari teater klasik hingga panggung sederhana. Teater juga berfungsi sebagai medium untuk menyampaikan pesan, menggugah perasaan, dan merangsang pemikiran penonton, serta mengeksplorasi tema-tema sosial dan budaya.
            </div>
            <div className="flex flex-col md:flex-row mt-6 font-lato">
              <CheckUser forLoggedOut>
                <div>
                  <Link to="/register/teater">
              ...
              <div>
                ...
                >
                  <button className="mx-auto text-cust-light-yellow border-cust-yellow border-2 rounded-md font-bold md:mx-2 my-2 mb-12 md:mb-2 flex justify-center hover:bg-white duration-200">
