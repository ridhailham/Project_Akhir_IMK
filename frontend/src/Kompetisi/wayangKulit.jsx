      ...
      <div className="min-h-screen w-full flex bg-light-blue-800">
        <div className="flex flex-col md:flex-row items-center justify-center px-8">
          ...
          <div className="w-full md:w-6/12">
            ...
            Wayang kulit adalah seni pertunjukan tradisional Indonesia yang dimainkan oleh seorang dalang yang menggerakkan boneka-boneka wayang dari belakang layar. Boneka-boneka wayang terbuat dari kulit hewan yang telah dikeringkan dan diberi warna. Pertunjukan wayang kulit biasanya menceritakan kisah-kisah kepahlawanan dari epos Ramayana dan Mahabharata. 
Wayang kulit adalah seni pertunjukan tradisional Indonesia yang dimainkan oleh seorang dalang yang menggerakkan boneka-boneka wayang dari belakang layar. Boneka-boneka wayang terbuat dari kulit hewan yang telah dikeringkan dan diberi warna. Pertunjukan wayang kulit biasanya menceritakan kisah-kisah kepahlawanan dari epos Ramayana dan Mahabharata. 
Wayang kulitTerbuka di jendela baru
umsu.ac.id
Wayang kulit

Wayang kulit memiliki peran penting dalam budaya Jawa, tidak hanya sebagai hiburan tetapi juga sebagai sarana pendidikan dan moral. Wayang kulit mengajarkan nilai-nilai luhur, seperti kepahlawanan, kesetiaan, dan kejujuran.
            </div>
            <div className="flex flex-col md:flex-row mt-6 font-lato">
              <CheckUser forLoggedOut>
                <div>
                  <Link to="/register/wayangkulit">
